...
async function dbLoad(table) {
  try { const t = await supa.from(table); return await t.select(); } catch { return null; }
}
...
const SEED_MEMBERS = [
  ...
  { id:2, name:"Maconhado", username:"maconhado", password:"member123", role:"Member", cls:"Archer", power:108904, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:3, name:"Puca", username:"puca", password:"member123", role:"Member", cls:"Archer", power:140132, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:4, name:"Satan", username:"satan", password:"member123", role:"Member", cls:"Archer", power:152540, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:5, name:"Maydreya", username:"maydreya", password:"member123", role:"Member", cls:"Archer", power:152655, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:6, name:"shadow丿代代", username:"shadow", password:"member123", role:"Member", cls:"Archer", power:196013, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:7, name:"iSekヅ", username:"isek", password:"member123", role:"Member", cls:"Archer", power:107937, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:8, name:"Vanessa", username:"vanessa", password:"elder123", role:"Elder", cls:"Archer", power:113429, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:9, name:"oyoyo", username:"oyoyo", password:"member123", role:"Member", cls:"Archer", power:115816, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:10, name:"itsShupapi", username:"itsshupapi", password:"member123", role:"Member", cls:"Archer", power:106042, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:11, name:"Isabella", username:"isabella", password:"elder123", role:"Elder", cls:"Archer", power:114807, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:12, name:"Exrtx1", username:"exrtx1", password:"member123", role:"Member", cls:"Archer", power:121187, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:13, name:"Patrick8P", username:"patrick8p", password:"member123", role:"Member", cls:"Archer", power:128611, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:14, name:"Karding", username:"karding", password:"member123", role:"Member", cls:"Archer", power:108966, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:15, name:"你奶奶个腿", username:"user15", password:"member123", role:"Member", cls:"Archer", power:136890, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:16, name:"Aucifer", username:"aucifer", password:"member123", role:"Member", cls:"Archer", power:194587, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:17, name:"Bubirka", username:"bubirka", password:"member123", role:"Member", cls:"Archer", power:138610, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:18, name:"SCARLETT01", username:"scarlett01", password:"member123", role:"Member", cls:"Archer", power:114971, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:19, name:"不要碧莲", username:"user19", password:"member123", role:"Member", cls:"Skald", power:135290, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:20, name:"XELLIN", username:"xellin", password:"member123", role:"Member", cls:"Skald", power:103925, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:21, name:"GinisangOtin", username:"ginisangotin", password:"member123", role:"Member", cls:"Skald", power:136894, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:22, name:"Netanyahu", username:"netanyahu", password:"elder123", role:"Elder", cls:"Rune Fighter", power:122326, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:23, name:"enilekam", username:"enilekam", password:"member123", role:"Member", cls:"Rune Fighter", power:110597, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:24, name:"patirik", username:"patirik", password:"member123", role:"Member", cls:"Rune Fighter", power:168705, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:25, name:"Toinha", username:"toinha", password:"member123", role:"Member", cls:"Rune Fighter", power:141185, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:26, name:"Ezel", username:"ezel", password:"member123", role:"Member", cls:"Rune Fighter", power:113311, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:27, name:"Naz", username:"naz", password:"member123", role:"Member", cls:"Rune Fighter", power:167587, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:28, name:"Artemisia", username:"artemisia", password:"member123", role:"Member", cls:"Rune Fighter", power:125850, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:29, name:"YeezyngLay", username:"yeezynglay", password:"member123", role:"Member", cls:"Rune Fighter", power:125437, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:30, name:"SDZAO", username:"sdzao", password:"member123", role:"Member", cls:"Rune Fighter", power:130828, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:31, name:"ikillyou", username:"ikillyou", password:"elder123", role:"Elder", cls:"Rune Fighter", power:126875, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:32, name:"sabar", username:"sabar", password:"member123", role:"Member", cls:"Rune Fighter", power:124665, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:33, name:"eithan10", username:"eithan10", password:"elder123", role:"Elder", cls:"Rune Fighter", power:125907, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:34, name:"Caliana", username:"caliana", password:"member123", role:"Member", cls:"Rune Fighter", power:115768, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:35, name:"Izingard", username:"izingard", password:"member123", role:"Member", cls:"Rune Fighter", power:130811, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:36, name:"JAJAMF", username:"jajamf", password:"member123", role:"Member", cls:"Rune Fighter", power:114617, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:37, name:"MiaKapilyaa", username:"miakapilyaa", password:"member123", role:"Member", cls:"Rune Fighter", power:115551, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:38, name:"Hades", username:"hades", password:"elder123", role:"Elder", cls:"Rune Fighter", power:149418, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:39, name:"d0ngd0ng", username:"d0ngd0ng", password:"member123", role:"Member", cls:"Rune Fighter", power:112695, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:40, name:"MiaKhalifa", username:"miakhalifa", password:"member123", role:"Member", cls:"Rune Fighter", power:113763, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:41, name:"ARIRANG", username:"arirang", password:"member123", role:"Member", cls:"Rune Fighter", power:139648, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:42, name:"WaSa", username:"wasa", password:"member123", role:"Member", cls:"Rune Fighter", power:149491, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:43, name:"Arisa", username:"arisa", password:"member123", role:"Member", cls:"Rune Fighter", power:124398, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:44, name:"Valk0Freya", username:"valk0freya", password:"member123", role:"Member", cls:"Rune Fighter", power:141853, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:45, name:"Yrsa", username:"yrsa", password:"member123", role:"Member", cls:"Rune Fighter", power:144771, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:46, name:"EKUPMANN", username:"ekupmann", password:"member123", role:"Member", cls:"Volva", power:111857, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:47, name:"Blessed", username:"blessed", password:"member123", role:"Member", cls:"Volva", power:113607, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:48, name:"AScott", username:"ascott", password:"member123", role:"Member", cls:"Archer", power:125753, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
  { id:49, name:"Asty", username:"asty", password:"member123", role:"Member", cls:"Rune Fighter", power:128026, coins:0, attendance:0, joinDate:"2024-01-01", auctionWins:0, decayLog:[], txLog:[], attendLog:[], discord:"" },
];
let _imageLibrary = [];
...
const FENRIR_BOW_IMG = "data:image/png;base64,";
const SEED_AUCTIONS = [
  { id:1, name:"Fenrir Recurve Bow (Bound)", image:{dataUrl:FENRIR_BOW_IMG,name:"Fenrir_Recurve_Bow"}, emoji:"", rarity:"epic", desc:"Tier 4 Archer Main Weapon", startBid:1, currentBid:1, topBidder:null, endsAt:Date.now()+1440*60000, status:"active", bids:[] },
];
...
function ItemImagePicker({ value, onChange, library, addImage }) {
  ...
  function handleFile(e) {
    ...
    reader.onload = ev => { const entry = addImage(file.name, ev.target.result); onChange(entry); };
    reader.readAsDataURL(file);
  }
  return (
    <div>
      <div style={{display:"flex",gap:8,marginBottom:8}}>
        <button type="button" className="btn btn-outline btn-sm" onClick={()=>fileRef.current.click()}>📁 Upload Image</button>
...
function WorldBossSchedule() {
  ...
  const todaySched = WEEKLY_SCHEDULE[jsToSched[new Date().getDay()]];
...
function Auctions({ ctx }) {
  ...
  function placeBid(auctionId) {
    ...
    const prevBid=a.currentBid!==a.startBid?a.currentBid:0;
    setMembers(ms=>ms.map(m=>{
          ...
          {active.map(a=>{
            ...
            return (
              <div key={a.id} className={`auction-card rarity-${a.rarity||"epic"}`}>
                <div className={`auction-img rarity-${a.rarity||"epic"}`}>
                  ...
                  <div className="auction-rarity-badge"><span className={`badge badge-${a.rarity||"epic"}`}>{a.rarity||"epic"}</span></div>
